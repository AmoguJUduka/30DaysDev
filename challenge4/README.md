...
1. I will advise you run the dockerfile in the same directory on your terminal.
2. If possible, update your "pip" before running the dockerfile
3. Make sure you cross-check your environment variable values
